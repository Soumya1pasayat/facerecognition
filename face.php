    ...
    <header class="text-gray-500 bg-gray-900 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a class="mr-5 hover:text-white" href="info.php">Home</a>
            ...
            <a class="mr-5 hover:text-white" href="register.php">SignUp</a>
          </nav>
          <a href="table.php">
      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">ABOUT GIETU
              <h6><br class="hidden lg:inline-block">"Education is the only mean to emphasis."</h6>
            </h1>
            <p class="mb-8 leading-relaxed">GIET, best University in Eastern India for campus placement. GIET University, Gunupur (formerly known as Gandhi Institute of Engineering and Technology) was established by “Vidya Bharati Educational Trust,” Gunupur, Odisha, India in the year 1997. Since inception, the Trust promotes Technical Education in India with a motto of providing Quality Education in a highly disciplined and conducive environment with International Standards.</p>
          </div>
      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="text-center mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-white mb-4">Face Detection Attendance System</h1>
            <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">  Attendance is a compulsory requirement of every organization.</p>
      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Doing things are great but first we have to initiate it in a proper way because unless we fail we can't reach to success.</p>
          </div>
      ...
      <section class="text-gray-500 body-font bg-gray-900">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Face is the new ID</h1>
            <p class="lg:w-1/2 w-full leading-relaxed text-base">Now access any of your office location globally with just a smile. Say cheese to GIETU!
